...
class Accepted_Requests : AppCompatActivity(),  AdapterClass.OnItemClickListener {
        ...
        if (userId != null) {
            ...
            dbref.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    userRecyclerview.adapter = AdapterClass(userArrayList, this@Accepted_Requests)
                }
    ...
    private fun showCustomDialog(data: DataClass) {
        ...
        requestListButton.setOnClickListener {
            ...
            val intent = Intent(this@Accepted_Requests, List_Requests::class.java)
